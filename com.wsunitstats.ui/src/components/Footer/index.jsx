...
export const Footer = () => {
  return (
    <footer>
      <h6>About</h6>
      <p className="text-justify">This is a free and open-source project desined to view War Selection in-game unit stats. Feel free to contact, ask any questions, report issues, make suggestions and contribute</p>
      <hr />
